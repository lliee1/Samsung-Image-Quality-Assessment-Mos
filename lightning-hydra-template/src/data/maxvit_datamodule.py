...
from MANIQA.data.koniq10k.koniq10k import (
    ...
    MyDataset_maxvit_test,
    MyDataset_maxvit_val,
    MyDataset_maxvit_train
)
...
class MaxvitDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        # )
        self.data_train: Optional[Dataset] = MyDataset_maxvit_train(
            csv_file=train_csv_file, transform=self.train_transforms
        )
        self.data_val: Optional[Dataset] = MyDataset_maxvit_val(
            csv_file=valid_csv_file, transform=self.val_transforms
        )
        self.data_test: Optional[Dataset] = MyDataset_maxvit_test(
