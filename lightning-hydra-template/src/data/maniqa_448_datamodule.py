...
class Maniqa_448DataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.val_transforms = transforms.Compose(
            [RandCrop(patch_size=448), Normalize(0.5, 0.5), ToTensor()]
        )
        self.test_transforms = transforms.Compose(
            [Normalize_test(0.5, 0.5), ToTensor_test()]
        )

        self.data_train: Optional[Dataset] = MyDataset_448(
            csv_file=train_csv_file, transform=self.train_transforms
        )
        self.data_val: Optional[Dataset] = MyDataset_448(
            csv_file=valid_csv_file, transform=self.val_transforms
        )
        self.data_test: Optional[Dataset] = MyDataset_448_test(
